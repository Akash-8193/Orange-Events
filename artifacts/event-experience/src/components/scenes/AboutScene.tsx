      ...
      <section className="w-full py-12 md:py-16 text-slate-900 border-b border-slate-100">
        <div className="max-w-[90rem] mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative w-full h-[500px] md:h-[600px] lg:h-[700px] flex items-center justify-center">
            ...
            <ImageReveal className="absolute left-0 top-4 w-[65%] aspect-square rounded-full overflow-hidden shadow-2xl z-10">
               <img src={imgCorporate} alt="Corporate Event" className="w-full h-full object-cover premium-image-zoom" />
            </ImageReveal>

            {/* Image 2: Right/Bottom offset (Pill/Oval) */}
            <ImageReveal className="absolute right-0 bottom-0 w-[55%] h-[80%] rounded-full overflow-hidden shadow-2xl z-20 border-[10px] border-white">
               <img src={imgWedding} alt="Luxury Wedding" className="w-full h-full object-cover premium-image-zoom" />
            </ImageReveal>

            {/* Floating Primary Badge */}
            <FloatingElement duration={4} yOffset={15} className="absolute bottom-16 left-0 md:left-4 z-30">
              <div className="bg-primary text-primary-foreground p-6 rounded-full w-48 h-48 flex flex-col items-center justify-center text-center shadow-xl shadow-primary/40">
          ...
          <div className="flex flex-col z-30">
            ...
            {/* Features Grid */}
            <StaggerContainer staggerDelay={0.1} className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6 mb-12">
              {[
      ...
      <section className="w-full py-12 md:py-16 bg-slate-50 text-slate-900 border-b border-slate-200">
        <div className="max-w-[90rem] mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col z-30">
            ...
            {/* Progress Bars */}
            <StaggerContainer staggerDelay={0.15} className="space-y-8 mb-12">
              <div>
          ...
          <div className="relative w-full h-[500px] lg:h-[650px] flex items-center justify-center mt-12 lg:mt-0">
             ...
             {/* Right Image */}
             <ImageReveal className="absolute right-0 bottom-10 w-[55%] h-[70%] rounded-[2rem] overflow-hidden shadow-2xl z-20 border-[8px] border-slate-50">
               <img src={expParty} alt="Gala Party" className="w-full h-full object-cover premium-image-zoom" />
             </ImageReveal>
        ...
        <div className="max-w-[90rem] mx-auto px-4 md:px-8">
          ...
          <StaggerContainer staggerDelay={0.2} className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
             {[
               ...
               <div key={i} className="premium-card relative group rounded-3xl overflow-hidden aspect-[4/5] md:aspect-auto md:h-[500px] bg-slate-900 shadow-xl">
                 <img src={card.img} alt={card.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 opacity-80 group-hover:opacity-100" />
      ...
      <section className="w-full py-12 md:py-16 bg-white text-slate-900">
        <div className="max-w-[90rem] mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative w-full h-[600px] lg:h-[750px] flex items-center justify-center">
            ...
            <ImageReveal className="absolute right-0 bottom-0 w-[65%] h-[70%] rounded-3xl overflow-hidden shadow-2xl z-20 border-[8px] border-white">
               <img src={whyCrowd} alt="Gala Crowd" className="w-full h-full object-cover premium-image-zoom" />
            </ImageReveal>
          ...
          <div className="flex flex-col z-30">
            ...
            <StaggerContainer staggerDelay={0.15} className="space-y-4 mb-12">
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start lg:items-center">
                ...
                <RevealAnimation delay={0.5} className="w-full lg:w-1/2">
                  <div className="bg-primary rounded-2xl p-8 text-primary-foreground shadow-xl shadow-primary/30">
      ...
      <section className="relative w-full py-20 md:py-28 bg-[#0a0a16] overflow-hidden text-white">
        ...
        <div className="relative max-w-[90rem] mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="relative w-full h-[500px] md:h-[600px] lg:h-[700px] rounded-2xl overflow-visible">
            {/* Main Image */}
            <ImageReveal className="w-full h-full rounded-2xl overflow-hidden shadow-2xl">
              <img src={wwdMain} alt="Event Excellence" className="w-full h-full object-cover premium-image-zoom" />
            </ImageReveal>

            {/* Overlapping Thumbnails Container */}
            <StaggerContainer staggerDelay={0.15} className="absolute -bottom-8 lg:-bottom-12 right-0 flex gap-4 pr-6 pb-6">
          ...
          <div className="flex flex-col z-10 pt-12 lg:pt-0">
            ...
            {/* Two Cards */}
            <StaggerContainer staggerDelay={0.15} className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
               {/* Card 1 */}
               <div className="premium-card bg-[#1a1a2e] rounded-xl p-6 flex items-center gap-4 border border-white/5 hover:border-primary/50 transition-colors shadow-lg">
            ...
            {/* Progress Bar */}
            <RevealAnimation delay={0.4} className="mb-12">
